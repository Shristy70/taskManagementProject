...
const LoginPage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center " id="divlogin">
      <div className="max-w-md w-full bg-white p-8 shadow-md rounded-lg text-center">
        ...
        <div className="space-y-4">
          ...
          <Link
            to="/user-login"
            className="block w-full py-2 px-4 bg-gery-200 text-white font-medium rounded-md shadow hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
          >
            User Login
          </Link>
        </div>
